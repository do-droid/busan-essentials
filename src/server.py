...
mcp = FastMCP(
    name="busan-essentials",
    instructions=(
        "Busan Essentials provides essential public facility data for foreign tourists visiting Busan, South Korea. "
        "Available data (6 types): public restrooms (toilet), pharmacies (pharmacy), "
        "free WiFi hotspots (wifi), AED/defibrillator locations (aed), "
        "tourist information centers (tourist_info), "
        "and subway timetables (Busan Metro 1-4 lines + Donghae Line + Busan-Gimhae Light Rail). "
        "All data is bilingual (Korean/English). "
