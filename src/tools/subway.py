...
def get_subway_timetable(
    ...
    Args:
        station: Station name in Korean or English (e.g., "해운대" or "Haeundae", "서면" or "Seomyeon").
        line: Line number (e.g., "1", "2", "3", "4"). If omitted for transfer stations, returns all lines.
