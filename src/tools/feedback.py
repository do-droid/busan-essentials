"""MCP tool for submitting feedback about Busan Essentials data."""
...
def submit_feedback(
    ...
    """Submit feedback about Busan Essentials data quality, coverage, or feature requests.
    ...
    Args:
        category: Type of feedback.
            ...
            - "coverage": Request geographic expansion (e.g., "include Ulsan area")
