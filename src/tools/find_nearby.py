...
def find_nearby(
    ...
    """Find public facilities near GPS coordinates in Busan, sorted by distance.

    Args:
        lat: Latitude of the search center point (Busan range: ~35.04 to ~35.40).
        lng: Longitude of the search center point (Busan range: ~128.78 to ~129.30).
        radius_m: Search radius in meters (100-5000, default 500).
        type: Optional filter by facility type —
            "toilet", "pharmacy", "wifi", "aed", "tourist_info".
